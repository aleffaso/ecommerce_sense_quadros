       ...
       img_hash +='<div class="order-number" style="text-align:center;">'+k+'</div></div>';
        ...
        if (l === "pequeno"){
          ...
          if (p === "preta"){
              ...
              img_selected += '<div><img style="border: 2px solid black;'+adapt_size+'" src="assets/img/pics/All/0'+result+'.jpg"/></div>';
          }else{
              img_color += '<div class="order-number-label">Moldura: Branca</div>';
              img_selected += '<div><img style="border: 2px solid white;'+adapt_size+'" src="assets/img/pics/All/0'+result+'.jpg"/></div>';
          }
