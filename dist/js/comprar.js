 ...
 function showCart(){
  ...
  img.onload = function() {
    ...
    if (widthSize > heightSize){
      adapt_size += 'style="width:250px;height:200px;margin-left:auto;margin-right:auto;"';
    }else{
      adapt_size += 'style="width:200px;height:250px;margin-left:auto;margin-right:auto;"';
    }
    ...
    for (var counter = result; counter <= x; counter++ ) {
      img_select += '<div '+colorSelected+'> <img '+adapt_size+' src="assets/img/pics/All/0'+counter+'.jpg" alt=""/></div>';
    }
...
var sizeAndColor = function(x){
  ...
  if(selectedSize === "pequeno"){
    ...
    if(selectedColor === "branca"){
      sizeAndColorSelected += '<h1>Quadro emoldurado </h1>';
    }else{
      sizeAndColorSelected += '<div style="top: 0; right:20%;" class="color black"></div><div style="top: 43px; right:20%;" class="type small">P</div>';
    }
  ...
  if(selectedSize === "medio"){
    ...
    if(selectedColor === "branca"){
      sizeAndColorSelected += '<div style="top: 0; right:20%;" class="color white"></div><div style="top: 43px;" class="type small">M</div>';
    }else{
  ...
  if(selectedSize === "grande"){
    ...
    if(selectedColor === "branca"){
      sizeAndColorSelected += '<div style="top: 0; right:20%;" class="color white"></div><div style="top: 43px; right:20%;" class="type small">G</div>';
    }else{
      sizeAndColorSelected += '<div style="top: 0; right:20%;" class="color black"></div><div style="top: 43px; right:20%;" class="type small">G</div>';
    }
    valorQuadro += '<h2 class="subtotal">Subtotal: R$ <span>'+valorSelecao+'</span></h2>';
    totalQuadro += '<h1 class="total">Total: R$ <span>'+valorFinal+'</span></h1>';
  }
...
function getAmountValue(valorSelecao){
  ...
  var root = "http://"+document.location.hostname+":5500/Documents/Sense/Original/";
